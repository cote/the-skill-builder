...
- `--package` — copy the zip to `dist/the-skill-builder.zip` and emit a CycloneDX SBOM at `dist/the-skill-builder.cdx.json` (tracked release artifacts).
...
```bash
cyclonedx validate --input-file dist/the-skill-builder.cdx.json
```
