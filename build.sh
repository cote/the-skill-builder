#!/bin/bash
# Build/package/install for the-skill-builder.
set -euo pipefail
...
Build the-skill-builder skill. Flags are opt-in and combinable.
    ...
    cat > "$SBOM" <<EOF
{
  ...
  "metadata": {
    ...
    "component": {
      ...
      "name": "$SKILL_NAME",
      "version": "1.0",
      "description": "Claude Code skill: scaffold a new standalone skill.",
